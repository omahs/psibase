...
pub mod program {
    ...
    pub struct Mysolproject;
    #[automatically_derived]
    #[allow(unused_qualifications)]
    impl ::core::clone::Clone for Mysolproject {
        #[inline]
        fn clone(&self) -> Mysolproject {
            match *self {
                Mysolproject => Mysolproject,
            }
        }
    }
    impl anchor_lang::Id for Mysolproject {
        fn id() -> Pubkey {
            ID
        }
    }
...
mod __private {
    ...
    pub mod __global {
        ...
        pub fn initialize(
            ...
            let result = mysolproject::initialize(anchor_lang::context::Context::new(
                program_id,
                &mut accounts,
                remaining_accounts,
                __bumps,
